...
<div class="wp-block-jonathanbossenger-ai-services-demo" data-instance="<?php echo esc_attr( $instance_id ); ?>">
	<div class="ai-chat" id="<?php echo esc_attr( $instance_id ); ?>">
		...
		<form class="ai-chat__form" method="post" action="#" onsubmit="return false;">
			<label class="screen-reader-text" for="<?php echo esc_attr( $instance_id ); ?>-input"><?php esc_html_e( 'Message', 'ai-services-demo' ); ?></label>
			<textarea class="ai-chat__input" id="<?php echo esc_attr( $instance_id ); ?>-input" rows="3" placeholder="<?php echo esc_attr__( 'Type your message…', 'ai-services-demo' ); ?>"></textarea>
